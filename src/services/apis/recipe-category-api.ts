...
export const RecipeCategoryApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllRecipeCategories(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<RecipeCategory>>>> {
            const localVarAxiosArgs = await RecipeCategoryApiAxiosParamCreator(configuration).getAllRecipeCategories(options);
 ...
 * @export
 */
export const RecipeCategoryApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * Returns a list of recipe categories containing all recipe categories from database
         * @summary Get all recipe categories
         ...
         * @throws {RequiredError}
         */
        async getAllRecipeCategories(options?: AxiosRequestConfig): Promise<AxiosResponse<Array<RecipeCategory>>> {
            return RecipeCategoryApiFp(configuration).getAllRecipeCategories(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class RecipeCategoryApi extends BaseAPI {
     ...
     */
    public async getAllRecipeCategories(options?: AxiosRequestConfig) : Promise<AxiosResponse<Array<RecipeCategory>>> {
        return RecipeCategoryApiFp(this.configuration).getAllRecipeCategories(options).then((request) => request(this.axios, this.basePath));
    }
}
