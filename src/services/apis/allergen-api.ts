...
export const AllergenApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllergens(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<AllergenRequest>>>> {
            const localVarAxiosArgs = await AllergenApiAxiosParamCreator(configuration).getAllergens(options);
 ...
 * @export
 */
export const AllergenApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        /**
         * Returns a list of allergens containing all allergens from database
         * @summary Get all allergens
         ...
         * @throws {RequiredError}
         */
        async getAllergens(options?: AxiosRequestConfig): Promise<AxiosResponse<Array<AllergenRequest>>> {
            return AllergenApiFp(configuration).getAllergens(options).then((request) => request(axios, basePath));
        },
    };
};
...
export class AllergenApi extends BaseAPI {
     ...
     */
    public async getAllergens(options?: AxiosRequestConfig) : Promise<AxiosResponse<Array<AllergenRequest>>> {
        return AllergenApiFp(this.configuration).getAllergens(options).then((request) => request(this.axios, this.basePath));
    }
}
