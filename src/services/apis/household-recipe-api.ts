...
export const HouseholdRecipeApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
    /**
     * Adds all the missing ingredients of the given recipe to the given household's shopping list.
     * @summary Adds missing ingredients from the recipe to the shopping list
     * @param {number} householdId ID of the household to add the recipe to
     * @param {number} id ID of the recipe to add
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    addRecipeToShoppingList: async (
      householdId: number,
      id: number,
      ...
      if (householdId === null || householdId === undefined) {
        throw new RequiredError(
          "householdId",
          "Required parameter householdId was null or undefined when calling addRecipeToShoppingList."
        );
      }
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling addRecipeToShoppingList."
        );
      }
      const localVarPath = `/householdrecipe/{householdId}/recipe/{id}/add-to-shoppinglist`
    ...
    createHouseholdRecipe: async (
      ...
      if (householdId === null || householdId === undefined) {
        throw new RequiredError(
          "householdId",
          "Required parameter householdId was null or undefined when calling createHouseholdRecipe."
        );
      }
      // verify required parameter 'id' is not null or undefined
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling createHouseholdRecipe."
        );
      }
    ...
    getHouseholdRecipes: async (
      ...
      if (householdId === null || householdId === undefined) {
        throw new RequiredError(
          "householdId",
          "Required parameter householdId was null or undefined when calling getHouseholdRecipes."
        );
      }
      const localVarPath = `/householdrecipe/{householdId}/recipe`.replace(
        `{${"householdId"}}`,
    ...
    removeHouseholdRecipe: async (
      ...
      if (householdId === null || householdId === undefined) {
        throw new RequiredError(
          "householdId",
          "Required parameter householdId was null or undefined when calling removeHouseholdRecipe."
        );
      }
      // verify required parameter 'id' is not null or undefined
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling removeHouseholdRecipe."
        );
      }
      const localVarPath = `/householdrecipe/{householdId}/recipe/{id}`
        .replace(`{${"householdId"}}`, encodeURIComponent(String(householdId)))
  ...
  return {
    ...
    async addRecipeToShoppingList(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => Promise<AxiosResponse<Array<RecipeIngredientDTO>>>
    > {
      const localVarAxiosArgs = await HouseholdRecipeApiAxiosParamCreator(
        configuration
     ...
     * @throws {RequiredError}
     */
    async createHouseholdRecipe(
      householdId: number,
      id: number,
      options?: AxiosRequestConfig
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<HouseholdRecipeDTO>>
    > {
      const localVarAxiosArgs = await HouseholdRecipeApiAxiosParamCreator(
        configuration
    ...
    async getHouseholdRecipes(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => Promise<AxiosResponse<Array<HouseholdRecipeDTO>>>
    > {
      const localVarAxiosArgs = await HouseholdRecipeApiAxiosParamCreator(
        configuration
      ).getHouseholdRecipes(householdId, options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs: AxiosRequestConfig = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
    ...
    async removeHouseholdRecipe(
      ...
      const localVarAxiosArgs = await HouseholdRecipeApiAxiosParamCreator(
        configuration
      ).removeHouseholdRecipe(householdId, id, options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs: AxiosRequestConfig = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url,
 ...
 * @export
 */
export const HouseholdRecipeApiFactory = function (
  ...
  return {
    ...
    async addRecipeToShoppingList(
      ...
      return HouseholdRecipeApiFp(configuration)
        .addRecipeToShoppingList(householdId, id, options)
    ...
    async createHouseholdRecipe(
      ...
      id: number,
      options?: AxiosRequestConfig
    ): Promise<AxiosResponse<HouseholdRecipeDTO>> {
      return HouseholdRecipeApiFp(configuration)
        .createHouseholdRecipe(householdId, id, options)
        .then((request) => request(axios, basePath));
    },
...
export class HouseholdRecipeApi extends BaseAPI {
   ...
   */
  public async addRecipeToShoppingList(
    householdId: number,
    id: number,
    options?: AxiosRequestConfig
  ): Promise<AxiosResponse<Array<RecipeIngredientDTO>>> {
    return HouseholdRecipeApiFp(this.configuration)
      .addRecipeToShoppingList(householdId, id, options)
   ...
   * @memberof HouseholdRecipeApi
   */
  public async createHouseholdRecipe(
    householdId: number,
    id: number,
    options?: AxiosRequestConfig
  ): Promise<AxiosResponse<HouseholdRecipeDTO>> {
   ...
   * @memberof HouseholdRecipeApi
   */
  public async getHouseholdRecipes(
    householdId: number,
    options?: AxiosRequestConfig
  ): Promise<AxiosResponse<Array<HouseholdRecipeDTO>>> {
    return HouseholdRecipeApiFp(this.configuration)
   ...
   * @memberof HouseholdRecipeApi
   */
  public async removeHouseholdRecipe(
    householdId: number,
    id: number,
    options?: AxiosRequestConfig
  ): Promise<AxiosResponse<void>> {
