...
export const HouseholdRecipeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        addRecipeToShoppingList: async (householdId: number, id: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'householdId' is not null or undefined
            if (householdId === null || householdId === undefined) {
                throw new RequiredError('householdId','Required parameter householdId was null or undefined when calling addRecipeToShoppingList.');
            }
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new RequiredError('id','Required parameter id was null or undefined when calling addRecipeToShoppingList.');
            }
...
export const HouseholdRecipeApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async addRecipeToShoppingList(householdId: number, id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<RecipeIngredientDTO>>>> {
            const localVarAxiosArgs = await HouseholdRecipeApiAxiosParamCreator(configuration).addRecipeToShoppingList(householdId, id, options);
...
export const HouseholdRecipeApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async addRecipeToShoppingList(householdId: number, id: number, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<RecipeIngredientDTO>>> {
            return HouseholdRecipeApiFp(configuration).addRecipeToShoppingList(householdId, id, options).then((request) => request(axios, basePath));
        },
        /**
         * Adds a recipe as bookmarked to the given household.
         * @summary Adds a recipe to a household
...
export class HouseholdRecipeApi extends BaseAPI {
     ...
     */
    public async addRecipeToShoppingList(householdId: number, id: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<Array<RecipeIngredientDTO>>> {
        return HouseholdRecipeApiFp(this.configuration).addRecipeToShoppingList(householdId, id, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Adds a recipe as bookmarked to the given household.
     * @summary Adds a recipe to a household
