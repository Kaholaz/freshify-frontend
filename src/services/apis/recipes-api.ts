...
export const RecipesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getRecipesPaginated: async (householdId: number, sortByIngredientsInFridge?: boolean, categoryId?: number, allergenIds?: Array<number>, pageNo?: number, pageSize?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'householdId' is not null or undefined
            if (householdId === null || householdId === undefined) {
...
export const RecipesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getRecipesPaginated(householdId: number, sortByIngredientsInFridge?: boolean, categoryId?: number, allergenIds?: Array<number>, pageNo?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<RecipeDTOPage>>> {
            const localVarAxiosArgs = await RecipesApiAxiosParamCreator(configuration).getRecipesPaginated(householdId, sortByIngredientsInFridge, categoryId, allergenIds, pageNo, pageSize, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const RecipesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getRecipesPaginated(householdId: number, sortByIngredientsInFridge?: boolean, categoryId?: number, allergenIds?: Array<number>, pageNo?: number, pageSize?: number, options?: AxiosRequestConfig): Promise<AxiosResponse<RecipeDTOPage>> {
            return RecipesApiFp(configuration).getRecipesPaginated(householdId, sortByIngredientsInFridge, categoryId, allergenIds, pageNo, pageSize, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class RecipesApi extends BaseAPI {
     ...
     * @memberof RecipesApi
     */
    public async getRecipesPaginated(householdId: number, sortByIngredientsInFridge?: boolean, categoryId?: number, allergenIds?: Array<number>, pageNo?: number, pageSize?: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<RecipeDTOPage>> {
        return RecipesApiFp(this.configuration).getRecipesPaginated(householdId, sortByIngredientsInFridge, categoryId, allergenIds, pageNo, pageSize, options).then((request) => request(this.axios, this.basePath));
    }
}
